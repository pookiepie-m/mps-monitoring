...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10 max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src="{{ asset('img/.PNG') }}" alt="azra" class="w-full h-60 object-cover">
        <div class="p-4 text-center">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src="{{ asset('img/gambar2.PNG') }}" alt="Firda" class="w-full h-60 object-cover">
        <div class="p-4 text-center">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src="{{ asset('img/.PNG') }}" alt="irpan" class="w-full h-60 object-cover">
        <div class="p-4 text-center">
